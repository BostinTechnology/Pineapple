...
function get_password (user_name, cb_func, callback) {
    ...
    var params = {
        TableName: 'Users',
        Key: { 
            "UserName": { 'S' : 'm@mlb.com'} //(string | number | boolean | null | Binary)
//            "UserName": { 'S' : userid} //(string | number | boolean | null | Binary)
        },
        AttributesToGet: [ 
            'Password'
        ],
